    ...
    <section className="relative overflow-hidden bg-slate-50 pt-16 md:pt-24 lg:pt-32 pb-16">
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6 flex flex-col lg:flex-row items-center gap-12">
        <div className="flex flex-1 flex-col items-start gap-6">
          ...
          <h1 className="text-4xl font-extrabold tracking-tight text-[#1A1053] sm:text-5xl lg:text-[4rem] max-w-2xl leading-[1.15]">
            Digital Healthcare<br />
            Ecosystem for<br />
            Hospitals, Diagnostics<br />
            & Patients
          </h1>
          
          <p className="max-w-[600px] text-[1.125rem] text-slate-600 leading-[1.75]">
            Unifying the global medical landscape through an
            intelligent, HIPAA-compliant platform designed for
            frictionless stakeholder collaboration.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4 w-full sm:w-auto">
            ...
            <button className="inline-flex items-center justify-center rounded-full bg-white px-8 py-3.5 text-sm font-semibold text-[#1A1053] shadow-sm ring-1 ring-inset ring-gray-200 hover:bg-gray-50 transition-all">
              Book Demo
            </button>
          </div>
        </div>
