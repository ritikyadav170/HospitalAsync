      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-12 max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-14 gap-8">
          ...
          <div className="flex gap-8 border-l-2 border-slate-100 pl-6 shrink-0">
            <div>
              <div className="text-4xl font-extrabold text-[#1A1053] tracking-tight">500+</div>
              <div className="text-xs font-bold text-slate-500 uppercase tracking-wider mt-1">
                Global Employees
              </div>
            </div>
            <div className="border-l border-slate-100 pl-8">
              <div className="text-4xl font-extrabold text-[#1A1053] tracking-tight">12</div>
              <div className="text-xs font-bold text-slate-500 uppercase tracking-wider mt-1">
                Regional Hubs
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 relative rounded-[2.5rem] overflow-hidden group shadow-xl shadow-slate-200/40 h-[380px] sm:h-[420px]">
            <Image
              src={career2}
          ...
          <div className="lg:col-span-4 bg-[#1A1053] rounded-[2.5rem] p-8 sm:p-10 flex flex-col justify-between text-white shadow-xl shadow-indigo-950/20 h-[380px] sm:h-[420px] relative overflow-hidden">
          ...
          {/* 3 Bottom Cards */}
          <div className="lg:col-span-4 bg-white border border-slate-200/80 rounded-[2rem] p-8 shadow-lg shadow-slate-200/30 hover:shadow-xl hover:border-slate-300 transition-all duration-300 flex flex-col justify-between">
            <div>
              <div className="bg-emerald-50 text-emerald-600 w-12 h-12 rounded-2xl flex items-center justify-center mb-6">
                <Rocket className="h-6 w-6" />
              </div>
              <h4 className="font-extrabold text-xl text-[#1A1053] mb-2">Continuous Growth</h4>
          ...
          <div className="lg:col-span-4 bg-white border border-slate-200/80 rounded-[2rem] p-8 shadow-lg shadow-slate-200/30 hover:shadow-xl hover:border-slate-300 transition-all duration-300 flex flex-col justify-between">
            <div>
              ...
              <h4 className="font-extrabold text-xl text-[#1A1053] mb-2">Remote-Native</h4>
              <p className="text-sm text-slate-500 leading-relaxed">
          ...
          <div className="lg:col-span-4 bg-white border border-slate-200/80 rounded-[2rem] p-8 shadow-lg shadow-slate-200/30 hover:shadow-xl hover:border-slate-300 transition-all duration-300 flex flex-col justify-between">
            <div>
              <div className="bg-cyan-50 text-teal-600 w-12 h-12 rounded-2xl flex items-center justify-center mb-6">
                <Users2 className="h-6 w-6" />
              </div>
              <h4 className="font-extrabold text-xl text-[#1A1053] mb-2">Work-Life Balance</h4>
              <p className="text-sm text-slate-500 leading-relaxed">
