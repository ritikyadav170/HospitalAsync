      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-8">
          <div className="max-w-2xl">
            <h2 className="text-3xl font-bold text-[#1A1053] mb-4">
              Life at HealthSync
            </h2>
            <p className="text-slate-600 leading-relaxed">
              We prioritize clinical precision with technical agility. Our
              culture is built on trust, transparency, and a shared passion for
              patient outcomes.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 relative rounded-[2rem] overflow-hidden group">
            ...
            <div className="absolute bottom-0 left-0 p-8 md:p-10 z-20">
              ...
              <p className="text-white/80 max-w-md text-sm md:text-base leading-relaxed">
                Bridging the gap between software engineering and clinical
                operations requires a unique blend of empathy and technical
                rigour.
              </p>
            </div>
          </div>
          ...
          <div className="bg-[#2bc4ff] rounded-[2rem] p-8 md:p-10 flex flex-col text-[#0a4666]">
            ...
            <p className="leading-relaxed font-medium">
              Comprehensive medical, dental, and mental health support for every
              single employee from day one.
            </p>
          </div>
          ...
          <div className="border border-slate-100 rounded-[2rem] p-8 shadow-xl shadow-slate-200/20">
            ...
            <p className="text-sm text-slate-500 leading-relaxed">
              Annual learning stipends and internal mobility programs to keep
              your career synchronized with your goals.
            </p>
          </div>
          ...
          <div className="border border-slate-100 rounded-[2rem] p-8 shadow-xl shadow-slate-200/20">
            ...
            <p className="text-sm text-slate-500 leading-relaxed">
              Work from where you are most productive. Our infrastructure is
          ...
          <div className="border border-slate-100 rounded-[2rem] p-8 shadow-xl shadow-slate-200/20">
            ...
            <p className="text-sm text-slate-500 leading-relaxed">
              Unlimited PTO and parental leave policies designed to support your
